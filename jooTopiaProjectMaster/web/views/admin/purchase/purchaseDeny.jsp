...
<%@ include file="/views/common/adminNavigation.jsp" %>
	...
	<%@ include file="/views/common/adminSideMenu.jsp" %>
		<div class="col-sm-10">
	    	<h3 class="title">매입신청 상세_매입거절</h3>
	    	<hr>
	    	...
	    	<div class="statusArea">	
	    		<table align="center">
	    			...
	    			<tr>
	    				<td>
	    					스크래치와 상품의 상태에 비해 희망금액이 높습니다.<br>
	    					죄송하지만 이번기회에 매입은 어려울 것 같습니다<br>
	    					판매를 희망하신다면 고객센터 혹은 게시글 재등록을 부탁드립니다<br>
	    					언제나 주토피아에 주시는 관심에 감사드립니다.
	    				</td>
	    			</tr>
	    		</table>
