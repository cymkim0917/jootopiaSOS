		...
		<div class="selectListArea">
			<table id="selectList" class="selectList" border="1">
				...
				<tr>
					...
					<th width="150px">배송예정일/배송코드</th>
					<th width="90px">배송완료일</th>
				...
				<tr>
					...
					<td>1</td>
					<td>배송완료</td>
					<td><a href="deliveryCompletedForm.jsp">2019-05-10 /<br>O20190510_01</a></td>
					<td><a href="deliveryCompletedForm.jsp">20190520 /<br>D20190520_01</a></td>
					<td>2019-05-20</td>
					<td>주문자</td>
					<td>상품명</td>
