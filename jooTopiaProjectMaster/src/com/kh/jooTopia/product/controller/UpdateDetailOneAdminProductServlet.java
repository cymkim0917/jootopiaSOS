...
@WebServlet("/updateDetailOneAdminProduct.do")
public class UpdateDetailOneAdminProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public UpdateDetailOneAdminProductServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(hmap != null) {
			view = "views/admin/product/productUpdateForm.jsp";
