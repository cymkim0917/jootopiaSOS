...
public class ProductDao {
	...
	public HashMap<String, Object> detailProduct(Connection con, int pid) {
		...
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = "SELECT DISTINCT PRODUCT.PID,PRODUCT.PNAME , PPRICE, PRODUCT.PBRAND , PRODUCT.PCONTENT,ATTACHMENT.CHANGE_NAME,PRODUCT.PMODELNAME,CATEGORY.CID,CATEGORY.CGROUP,CATEGORY.NAME,PURCHASE.USE_PERIOD FROM PRODUCT,CATEGORY,ATTACHMENT,PURCHASE WHERE CATEGORY.CID = PRODUCT.CID AND PRODUCT.PID = ATTACHMENT.PID AND CATEGORY.CID = PURCHASE.CID AND PRODUCT.PID = ? AND PRODUCT.STATUS = '판매중' AND ATTACHMENT.STATUS = 'Y'";
