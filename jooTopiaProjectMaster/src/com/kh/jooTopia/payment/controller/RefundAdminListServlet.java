...
@WebServlet("/refundAdminList.do")
public class RefundAdminListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public RefundAdminListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = "SELECT COUNT(*) FROM PAYMENT WHERE STATUS = '결제취소'";
		...
		ArrayList<HashMap<String, Object>> list = new PaymentAdminService().selectRefundList(pageInfo);

		String view = "";
		if(list != null) {
			view = "views/admin/order/refundList.jsp";
			request.setAttribute("list", list);
			request.setAttribute("pageInfo", pageInfo);
		}else {
			view = "views/common/errorPage500.jsp";
			request.setAttribute("msg", "환불목록 리스트 조회 실패");
		}
