...
public class BuyWaitAdmin implements java.io.Serializable{
	...
	private String applicantPhone;	//APPLICANT_PHONE - 신청자연락처
	...
	public BuyWaitAdmin(int pId, int hId, int rlId, int pcdId, String cGroup, String name, int odId, int dId,
			int lBarcode, Date rlDate, Date hDate, String status, String applicant, String applicantPhone) {
		super();
		this.pId = pId;
		this.hId = hId;
		this.rlId = rlId;
	...
	public String toString() {
		return "BuyWaitAdmin [pId=" + pId + ", hId=" + hId + ", rlId=" + rlId + ", pcdId=" + pcdId + ", cGroup="
				...
				+ rlDate + ", hDate=" + hDate + ", status=" + status + ", applicant=" + applicant + ", applicantPhone="
				+ applicantPhone + "]";
	}
