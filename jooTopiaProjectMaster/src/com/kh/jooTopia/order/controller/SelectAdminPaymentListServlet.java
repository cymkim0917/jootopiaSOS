...
@WebServlet("/selectAdminPaymentList.do")
public class SelectAdminPaymentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectAdminPaymentListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = "SELECT COUNT(*) FROM PORDER WHERE STATUS = '주문완료'";
		...
		ArrayList<HashMap<String, Object>> list = new OrderAdminService().selectPaymentList(pageInfo);
		
		String view = "";
		if(list != null) {
			view = "views/admin/order/paymentList.jsp";
