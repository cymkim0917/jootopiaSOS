...
@WebServlet("/selectAdminDelCompletedList.do")
public class SelectAdminDeliveryCompletedListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectAdminDeliveryCompletedListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<HashMap<String, Object>> list = new DeliveryAdminService().selectDelCompletedList(pageInfo);

		String view = "";
		if(list != null) {
			view = "views/admin/order/deliveryCompletedList.jsp";
			request.setAttribute("list", list);
			request.setAttribute("pageInfo", pageInfo);
		}else {
			view = "views/common/errorPage500.jsp";
			request.setAttribute("msg", "배송완료 리스트 조회 실패");
		}
