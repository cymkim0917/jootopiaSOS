...
@WebServlet("/selectAdminDeliveryList.do")
public class SelectAdminDeliveryListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SelectAdminDeliveryListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<HashMap<String, Object>> list = new DeliveryAdminService().selectDeliveryList(pageInfo);

		String view = "";
		if(list != null) {
			view = "views/admin/order/deliveryList.jsp";
			request.setAttribute("list", list);
			request.setAttribute("pageInfo", pageInfo);
		}else {
			view = "views/common/errorPage500.jsp";
			request.setAttribute("msg", "배송중 리스트 조회 실패");
		}
