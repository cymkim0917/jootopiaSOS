...
/**
 * Servlet implementation class SearchAdminQnAServlet
 */
@WebServlet("/searchAdminQnA.do")
public class SearchAdminQnAServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchAdminQnAServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String answerType = request.getParameter("answer");
		String searchId = request.getParameter("searchId");
		
		HashMap<String, Object> hmap = new BoardAdminService().searchQnA(pageInfo, answerType, searchId);
