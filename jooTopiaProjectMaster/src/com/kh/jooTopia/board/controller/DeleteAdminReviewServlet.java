...
/**
 * Servlet implementation class DeleteAdminReviewServlet
 */
@WebServlet("/deleteAdminReview.do")
public class DeleteAdminReviewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteAdminReviewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result==bId.length) {
			 response.sendRedirect(request.getContextPath()+"/selectAdminReview.do");
		}else {
