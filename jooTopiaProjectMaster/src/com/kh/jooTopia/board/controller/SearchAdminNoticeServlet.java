...
/**
 * Servlet implementation class SearchAdminNoticeServlet
 */
@WebServlet("/searchAdminNotice.do")
public class SearchAdminNoticeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchAdminNoticeServlet() {
        super();
